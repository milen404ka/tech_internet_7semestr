...
class Tasklist {
  ...
  onAddTaskButtonClick = async () => {
    const newTaskName = prompt('Введите название книги');
  ...
  onEditTask = async (taskID) => {
    ...
    const newTaskName = prompt('Введите новое название книги', oldTaskName);
  ...
  render() {
    ...
    header.innerHTML = 'Номер шкафа:<br>' + this.tlName;
    tasklist.appendChild(header);

    const time = document.createElement('header');
    time.classList.add('tm-tasklist-header');
    time.innerHTML = 'Тип шкафа:<br>' + this.tlTime;
